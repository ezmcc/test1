...
import type { CustomPage as FPMCustomPage, CustomTableColumn as FPMCustomTableColumn, CustomSection as FPMCustomSection, ObjectPage as FPMObjectPage, CustomAction as FPMCustomAction, CustomView as FPMCustomView, ControllerExtension as FPMControllerExtension, CustomSubSection as FPMCustomSubSection, CustomHeaderSection as FPMCustomHeaderSection, CustomFilter as FPMCustomFilter } from '@sap-ux/fe-fpm-writer';
...
export type CustomExtensionData = FPMCustomPage | FPMCustomTableColumn | FPMCustomSubSection | FPMCustomHeaderSection | FPMCustomSection | FPMObjectPage | FPMCustomAction | FPMCustomView | FPMControllerExtension | FPMCustomFilter;
/**
 * API Version
 */
